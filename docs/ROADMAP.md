...
- **次の入口はNPSのプロファイル**（2026-07-29オーナー決定）。
  [ADR-0089](adr/0089-improvement-criteria.md)の軸1で、探索の出力が
  1ビットも変わらない高速化を探す。突出した箇所がなければ深追いしない。
  現状は約1.2M nps（M4、1スレッド、NNUE込み、初期局面）
