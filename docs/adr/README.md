...
| [0201](0201-loop-recipe.md) | 自己生成と継続学習のループを型にし、資源の投資対効果を見積もる | 2026-09-04 |  | accepted |
...
| [0205](0205-relabel-loop.md) | 教師の局面を自分の探索で付け直し、ゼロから学習し直す世代を試す | 2026-09-09 |  | proposed |
