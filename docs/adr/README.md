...
| gensfen設計 | 開始局面多様化、勝敗ラベル。持将棋は24点法で裁定する（2028年選手権から27点法→24点法に変更予定。2026-07-20オーナー情報。詳細規定は公式発表を正とする） |
| 宣言勝ちの24点法対応 | ADR-0030は27点法（CSA）。24点法モードを追加しUSIオプションで切替。selfplayの裁定も揃える |
