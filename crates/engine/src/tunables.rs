...
tunables! {
    ...
    NMP_EVAL_IMPROVING: crate::value::Value = 44, [0, 200];
    NMP_EVAL_BASE: crate::value::Value = 406, [50, 1000];
    NMP_BASE_REDUCTION: u32 = 7, [3, 12];
    NMP_DEPTH_DIVISOR: u32 = 3, [1, 8];
    // 子ノードのfutility（RFP。式と出典はsearch.rsのRFP_MAX_DEPTH群のコメント）
    RFP_MULT: i32 = 99, [20, 200];
    RFP_NO_TT_HIT: i32 = 18, [0, 80];
    RFP_IMPROVING: i32 = 1093, [500, 8000];
    RFP_OPP_WORSENING: i32 = 211, [0, 2000];
    // 親ノードのfutility（式と出典はsearch.rsのFUTILITY_MAX_DEPTHのコメント）
    FUTILITY_BASE: crate::value::Value = 39, [0, 300];
    FUTILITY_NO_BEST: crate::value::Value = 156, [0, 500];
    FUTILITY_MARGIN: crate::value::Value = 119, [30, 400];
    FUTILITY_OVER_ALPHA: crate::value::Value = 88, [0, 300];
    ...
    // depthの2乗で伸びる
    RAZOR_BASE: crate::value::Value = 436, [100, 1500];
    RAZOR_DEPTH_COEF: crate::value::Value = 275, [50, 1000];
    ...
    SEE_CAPTURE_COEF: i32 = 140, [40, 500];
    SEE_CAPT_HIST: i32 = 30, [0, 150];
    // 取る手のfutility（式と出典はsearch.rsのCAPT_FUTILITY_MAX_DEPTH群のコメント）
    CAPT_FUTILITY_BASE: crate::value::Value = 206, [0, 800];
    CAPT_FUTILITY_DEPTH: crate::value::Value = 207, [50, 800];
    ...
    QS_FUTILITY_MARGIN: crate::value::Value = 249, [80, 1000];
    QS_SEE_MARGIN: crate::value::Value = -67, [-300, 50];
    ...
    ASPIRATION_BASE: crate::value::Value = 8, [2, 30];
    ASPIRATION_MSS_DIV: crate::value::Value = 8341, [2000, 30000];
    ...
    LMR_COEF: i32 = 3101, [1000, 6000];
    LMR_DEPTH_HIST_DIVISOR: i32 = 3608, [800, 12000];
}
