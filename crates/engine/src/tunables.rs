...
tunables! {
    ...
    NMP_EVAL_IMPROVING: crate::value::Value = 53, [0, 200];
    NMP_EVAL_BASE: crate::value::Value = 378, [50, 1000];
    NMP_BASE_REDUCTION: u32 = 7, [3, 12];
    NMP_DEPTH_DIVISOR: u32 = 3, [1, 8];
    // 子ノードのfutility（RFP。式と出典はsearch.rsのRFP_MAX_DEPTH群のコメント）
    RFP_MULT: i32 = 76, [20, 200];
    RFP_NO_TT_HIT: i32 = 21, [0, 80];
    RFP_IMPROVING: i32 = 2686, [500, 8000];
    RFP_OPP_WORSENING: i32 = 362, [0, 2000];
    // 親ノードのfutility（式と出典はsearch.rsのFUTILITY_MAX_DEPTHのコメント）
    FUTILITY_BASE: crate::value::Value = 42, [0, 300];
    FUTILITY_NO_BEST: crate::value::Value = 151, [0, 500];
    FUTILITY_MARGIN: crate::value::Value = 120, [30, 400];
    FUTILITY_OVER_ALPHA: crate::value::Value = 86, [0, 300];
    ...
    // depthの2乗で伸びる
    RAZOR_BASE: crate::value::Value = 502, [100, 1500];
    RAZOR_DEPTH_COEF: crate::value::Value = 306, [50, 1000];
    ...
    // 大きな損だけ刈る」
    SEE_QUIET_COEF: i32 = 25, [5, 100];
    SEE_CAPTURE_COEF: i32 = 167, [40, 500];
    SEE_CAPT_HIST: i32 = 34, [0, 150];
    // 取る手のfutility（式と出典はsearch.rsのCAPT_FUTILITY_MAX_DEPTH群のコメント）
    CAPT_FUTILITY_BASE: crate::value::Value = 218, [0, 800];
    CAPT_FUTILITY_DEPTH: crate::value::Value = 223, [50, 800];
    ...
    QS_FUTILITY_MARGIN: crate::value::Value = 328, [80, 1000];
    QS_SEE_MARGIN: crate::value::Value = -73, [-300, 50];
    ...
    ASPIRATION_BASE: crate::value::Value = 5, [2, 30];
    ASPIRATION_MSS_DIV: crate::value::Value = 9000, [2000, 30000];
    ASPIRATION_GROWTH_DIV: crate::value::Value = 3, [2, 8];
    ...
    LMR_COEF: i32 = 2763, [1000, 6000];
    LMR_DEPTH_HIST_DIVISOR: i32 = 3220, [800, 12000];
}
...
mod tests {
    ...
    fn set_updates_and_clamps() {
        assert_eq!(RFP_MULT(), 76);
        assert!(set("RFP_MULT", 100));
        assert_eq!(RFP_MULT(), 100);
        // 可動域の外はclampされる
        assert!(set("RFP_MULT", 10_000));
        assert_eq!(RFP_MULT(), 200);
        assert!(set("RFP_MULT", 76));
        assert_eq!(RFP_MULT(), 76);
    }
